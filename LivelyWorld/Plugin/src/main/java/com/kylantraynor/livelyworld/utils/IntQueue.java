...
public class IntQueue implements Queue<Integer> {
    ...
    public boolean contains(Object o) {
        if(o instanceof Integer){
            for(int i = head; i < tail; i++){
                if(array[i] == (Integer)o) return true;
            }
        }
        return false;
    }
     ...
     * {@code false}
     */
    public boolean offerInt(int integer){
        if(tail == array.length){
            if(head > 0) {
                flushLeft();
            } else {
     ...
     * {@code int} instead of the wrapper {@link Integer}.
     *
     * @return the head of this queue
     * @throws NoSuchElementException if this queue is empty
     */
     ...
     * primitive {@code int} instead of the wrapper {@link Integer}.
     *
     * @return the head of this queue
     * @throws NoSuchElementException if this queue is empty
     */
