...
public class BurnModule implements Listener {
	...
	public void onBlockIgnite(BlockIgniteEvent event){
		if(event.getCause() == IgniteCause.SPREAD && event.getIgnitingBlock() != null){
		...
		//plugin.log(Level.INFO, "Block ignited: " + block.getType().toString());;
	...
	public void onBlockBurn(BlockBurnEvent event){
		...
		//plugin.log(Level.INFO, "Block burning: " + block.getType().toString());;
		switch(block.getType()){
		case LOG: case LOG_2: case COAL_BLOCK:
